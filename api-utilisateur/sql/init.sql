...
INSERT INTO "users" ("id", "name", "surname", "pseudo", "linkpic") VALUES
    ('9bc9ec6a-e9c3-483c-b799-ad208c32e6d2', 'Clement', 'Brito', 'Clem1', 'default.jpg'),
    ('e4fb9d21-7dd6-4ce5-b32a-ecdcf936e3da', 'Paul', 'Bruson', 'Polo', 'default.jpg'),
...
DROP TABLE IF EXISTS "demmands";
CREATE TABLE "public"."demmands" (
    "id" uuid DEFAULT uuid_generate_v4() NOT NULL,
